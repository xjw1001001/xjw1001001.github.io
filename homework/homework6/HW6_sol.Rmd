...
A null hypothesis is a statement that there is no significant difference or relationship between two variables in a population. It is typically denoted as H0. The alternative hypothesis, denoted as Ha, is the opposite of the null hypothesis, and it states that there is a significant difference or relationship between two variables in a population.

The significance level, denoted as α, is the probability of rejecting the null hypothesis when it is actually true. It is typically set at 0.05 or 0.01 in social science research, meaning that there is a 5% or 1% chance of rejecting the null hypothesis when it is actually true.

The decision rule for rejecting or failing to reject the null hypothesis is based on the p-value. If the p-value is less than or equal to the significance level, then the null hypothesis is rejected in favor of the alternative hypothesis. If the p-value is greater than the significance level, then the null hypothesis is not rejected.

The p-value is the probability of obtaining a test statistic as extreme or more extreme than the observed one, assuming that the null hypothesis is true. It is a measure of the strength of evidence against the null hypothesis. A small p-value (less than the significance level) indicates strong evidence against the null hypothesis, while a large p-value indicates weak evidence against the null hypothesis.
...
The shape is left skewed. We should use the Z confidence interval with sigma unknown. It may not be a good method because the distribution is greatly left skewed. There are also no sample that bigger than 180.

Interpretation: We are $95\%$ confidence that the average draws to get first Seele is between 120.6236 and 125.6374.
