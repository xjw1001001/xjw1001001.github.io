...
There are 2 types of data to construct bar plot.
  ...
  - Here we have to use the case 2 code, `ggplot(T1, aes(x = homeownership, y = n))` +
  `geom_bar(stat = "identity")`
]
.panel[.panel-name[Column is Category]
...
.panel[.panel-name[Column is count]
.tiny[
```{r message = TRUE, fig.height=3}
...
There are 2 types of data to construct bar plot. One is category in the column, each row stands for 1 observation. Another is Each row is 1 category, with a row indicating the counts/totals.
