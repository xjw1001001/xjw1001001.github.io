...
subtitle: "<br><br> STA 032: Gateway to data science Lecture 21"
...
|:------|:------:|:---------:|
| Decision: Do Not Reject $H_0$ | $\checkmark$ | Type II `r emo::ji("skull_and_crossbones")` |
| Decision: Reject $H_0$ | Type I `r emo::ji("skull_and_crossbones")`  | $\checkmark$ | 
